Amplifize::Application.configure do
  ...
  # config.assets.precompile += %w( homepage.css, bootstrap-dropdown.js )
  ...
  config.action_mailer.default_url_options = { :host => "amplifize.com" }
  ...
  config.oauth2 = {
    :google => {
      ...
      :client_id => "243455842448.apps.googleusercontent.com",
      :client_secret => "yz5rjoR3n88i_1kZPMNsrO19",
  ...
  config.show_support_widget = true
